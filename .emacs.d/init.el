...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-jedi python-mode exec-path-from-shell ember-mode web-mode rjsx-mode restart-emacs auctex org-tree-slide undo-tree evil-colemak-basics xref-js2 which-key visual-fill-column use-package typescript-mode treepy rainbow-delimiters org-gcal org-bullets no-littering magit lsp-ui lsp-ivy lsp-haskell lsp-dart js2-refactor ivy-rich helpful general evil-nerd-commenter evil-collection doom-themes doom-modeline dart-server counsel-projectile company-box command-log-mode all-the-icons-dired))
 '(tab-width 4))
(custom-set-faces
